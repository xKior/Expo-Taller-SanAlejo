...
import { getContenedorById, updateContenedor, Contenedor } from '@/db';

export default function EditContenedorScreen() {
  ...
  const handleSave = async () => {
    ...
    setLoading(true);
    try {
      await updateContenedor(contenedorId, nombre, descripcion, ubicacion);
      Alert.alert('Éxito', 'Contenedor actualizado correctamente', [
        {
          text: 'OK',
          onPress: () => router.back(),
        },
